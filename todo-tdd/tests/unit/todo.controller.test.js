...
// This replace all the above
jest.mock("../../model/todo.model");

let req, res, next;
const todoId = "621874646b9b9c51903489a2";
...
describe("TodoController.deleteTodo", () => {
  ...
  it("should return response with deletedModel and status code 200", async () => {
...
describe("TodoController.updateTodo", () => {
  it("should have a updateTodo functions", () => {
  ...
  it("should return response with JSON data and status code 200", async () => {
    req.params.todoId = todoId;
    req.body = newTodo;
...
describe("TodoController.getTodoById", () => {
  ...
  it("should return json body and response with status 200", async () => {
